        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-2/3 space-y-12">
            <section className="bg-white p-8 rounded-2xl shadow-sm border border-sand-200">
              <h2 className="text-2xl font-bold text-savanna-900 mb-6">Overview</h2>
            ...
            <section className="bg-white p-8 rounded-2xl shadow-sm border border-sand-200">
              <h2 className="text-2xl font-bold text-savanna-900 mb-6">What's Included</h2>
          ...
          <div className="lg:w-1/3">
            <div className="sticky top-28 bg-white p-8 rounded-2xl shadow-lg border border-sand-200">
              <h3 className="text-xl font-bold text-savanna-900 mb-2">Book this Safari</h3>
              <p className="text-sand-600 text-sm mb-6">Starting price per person</p>
              ...
              <Link href="/contact" className="block w-full text-center bg-savanna-900 hover:bg-savanna-950 text-white font-bold py-4 px-6 rounded-xl transition-all shadow-md hover:shadow-lg transform hover:-translate-y-1">
                Inquire Now
              </Link>
