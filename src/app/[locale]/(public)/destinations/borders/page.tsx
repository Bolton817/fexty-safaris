...
const SUB_CATEGORIES = [
  ...
  { id: 'bali', title: 'Bali' },
  { id: 'malaysia-singapore', title: 'Malaysia & Singapore' },
  { id: 'europe', title: 'Europe' },
  { id: 'cape-town', title: 'Cape Town' },
];
    ...
    <div className="flex-1 flex flex-col bg-white">
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden bg-savanna-950">
        <div className="absolute inset-0">
          <img 
            src="https://images.unsplash.com/photo-1512453979436-5a536f1158a4?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80" 
            alt="Beyond Borders" 
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-lg md:text-xl text-sand-200 max-w-2xl mx-auto font-light leading-relaxed">
            Expand your horizons and explore the world's most captivating international destinations with our curated global packages.
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-16 lg:py-24 space-y-24">
        {groupedPackages.length === 0 ? (
          <div className="text-center py-20 text-sand-500">
            <p className="text-xl">Packages for this destination are currently being updated.</p>
          ...
          groupedPackages.map((group) => (
            <section key={group.id} id={group.id} className="scroll-mt-24">
              <div className="flex items-end justify-between mb-10 border-b border-sand-100 pb-6">
                <div>
                  <h2 className="text-[10px] font-bold text-sunset-500 tracking-[0.2em] uppercase mb-2">Explore</h2>
                ...
                {group.packages.map((pkg) => (
                  ...
                  >
                    <div className="relative aspect-[4/3] overflow-hidden bg-sand-200">
                      <img 
                        src={pkg.image_url || 'https://images.unsplash.com/photo-1512453979436-5a536f1158a4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80'} 
                        alt={pkg.title} 
