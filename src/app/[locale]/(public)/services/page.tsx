...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* 1. Customized Tour Packages (Layout: Text Left, Image Right, bg-white) */}
      ...
      {/* 2. Group Tours (Layout: Image Left, Text Right, bg-sand-50) */}
      ...
      {/* 3. Corporate Travel (Layout: Full width background overlay) */}
      ...
      {/* 4. Honeymoon & Romantic Getaways (Layout: Overlapping Images & Card) */}
      ...
      {/* 5. Destination Weddings (Layout: Text Left, Image Right, bg-sand-50) */}
      ...
      {/* 6. Ticketing & Visa Services (Layout: Centered Grid blocks) */}
      ...
      {/* 7. Cruise Packages (Layout: Text Right, Image Left, bg-sand-900 dark theme) */}
      ...
      {/* 8. Adventure Travel (Layout: Image Right, Text Left, bg-white) */}
